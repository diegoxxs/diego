...
global.author = 'DiegoGT' //ganti aja cuyyy
global.namebot = '​Diego BOT' //nama bot luh
global.wm = '© Diego BOT' //ganti aja
global.media = 'https://telegra.ph/file/5d45a3d1e12726d98c5e4.jpg' //bebas
global.wm = 'Diego-GT ' //wm nyaa kocak
global.watermark = wm //bebas
global.wm2 = 'DiegoGT' //ganti ajaa 
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`//ga usah dehhh 
global.bottime = `T I M E : ${wktuwib}` //ini juga ga usah 
global.titlebot = `Diego BOT | DiegoGT` //gantu aja
global.stickpack = 'Amelia-Modz' //ganti 
global.stickauth = `© Diego BOT` //gantii 
global.week = `${week} ${date}`
global.wibb = `${wktuwib}`
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ OWNER INFO ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.nameown1= 'Amelia Putri septiany' //ganti 
global.nameown2 = 'DiegoGT' //ganti 
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ MEDIA LINK ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
...
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ MEDIA SOSSIAL ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.sig = 'https://instagram.com/diegostore__' //ganti jadi ig mu
